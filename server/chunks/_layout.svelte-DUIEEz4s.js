...
function Header($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--></button> <a href="/" class="font-normal text-xl hidden sm:block tracking-wide transition-colors duration-700">SOLARYX</a></div> `);
    if (![
      "/login",
      "/signup",
      "/create",
    ...
    if (store_get($$store_subs ??= {}, "$page", page).url.pathname === "/" || store_get($$store_subs ??= {}, "$page", page).url.pathname === "/my-bets") {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="topic-switcher relative flex items-center ml-2 rounded-full p-0.5 bg-white/[0.06]"><div class="topic-pill absolute top-0.5 left-0 h-[calc(100%-4px)] rounded-full transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] pointer-events-none bg-white/[0.12] shadow-[0_0_12px_rgba(255,255,255,0.08)]"${attr_style(pillStyle)}></div> <!--[-->`);
...
//# sourceMappingURL=_layout.svelte-DUIEEz4s.js.map
