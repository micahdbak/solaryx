...
>
    ...
    <nav class="flex justify-between items-center px-4 md:px-8 py-4 w-full">
        <div class="flex items-center gap-4 md:gap-8 flex-1">
            ...
            >
            {#if $page.url.pathname !== "/login" && $page.url.pathname !== "/signup" && $page.url.pathname !== "/create" && $page.url.pathname !== "/settings" && $page.url.pathname !== "/terms"}
                <div
        ...
        <div class="flex items-center gap-4 pl-4">
            {#if !data?.user}
                ...
                <a
                    href="/signup"
                    class="px-5 py-2 rounded-full font-semibold no-underline transition-all duration-700 text-sm cursor-pointer whitespace-nowrap text-white hover:-translate-y-px {$isEvilStore
