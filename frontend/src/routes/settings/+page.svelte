    ...
    <div class="space-y-4">
        {#each menuItems as item}
            <button
                ...
                class="w-full text-left bg-[#11141c] {$isEvilStore
            ...
            >
                <div class="flex items-center gap-6 m-3">
                    <div
                        class="flex-shrink-0 w-12 h-12 rounded-lg {$isEvilStore
                            ? 'bg-red-950/40'
                    ...
                    <div class="flex-1 min-w-0">
                        <div
                            class="text-white font-semibold text-sm group-hover:text-gray-100"
                        >
                            {item.label}
                        </div>
                        <div
