...
>
    ...
    <div class="space-y-4">
        <!-- Chart Box -->
        <div
            class="relative bg-[#11141c] {$isEvilStore
            ...
            <div class="mb-2 pt-4">
                ...
                <div class="flex justify-between items-center mb-2">
                    <div class="flex items-baseline gap-4">
                        ...
                        <span
                            class="text-base md:text-lg font-bold {currentBet
                                .optionB.color} var-text-palestine"
                        >
            ...
            <table class="w-full text-left">
                ...
                >
                    ...
                    >
                        ...
                        <td class="py-3 px-4 flex items-center gap-2"
                            ><img
                                ...
                                class="w-6 h-6 rounded bg-gray-800"
                                alt="avatar"
                        ...
                        <td class="py-3 px-4"
                            ><span
                                class="var-color-optionA var-text-israel var-bg-optionA-light px-2 py-0.5 rounded text-xs border"
                                >Israel Aid</span
                            ></td
                        >
                        <td
                    ...
                    >
                        ...
                        <td class="py-3 px-4"
                            ><span
                                class="var-color-optionB var-text-palestine var-bg-optionB-light px-2 py-0.5 rounded text-xs border"
    ...
    <div class="sticky top-24 self-start space-y-3">
        ...
        >
            ...
            <div class="space-y-3 relative group">
                ...
                <div class="flex gap-2 text-xs font-semibold">
                    ...
                    <button
                        class="flex-1 py-2 bg-gray-800/80 hover:bg-gray-700 rounded-lg text-gray-300 transition-colors cursor-pointer"
                        onclick={() => (donationAmount = Number(donationAmount) + 10)}>+$10</button
                    >
                    <button
                        class="flex-1 py-2 bg-gray-800/80 hover:bg-gray-700 rounded-lg text-gray-300 transition-colors cursor-pointer"
                        onclick={() => (donationAmount = Number(donationAmount) + 100)}>+$100</button
                    >
                    <button
                        class="flex-1 py-2 bg-gray-800/80 hover:bg-gray-700 rounded-lg text-gray-300 transition-colors cursor-pointer"
        ...
        >
            ...
            <span class="text-lg font-extrabold text-white">$34,000,000</span>
        </div>
    </div>
</section>
