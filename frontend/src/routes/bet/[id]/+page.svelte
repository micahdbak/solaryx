<script>
	...
	let currentBet = $derived(bets.find((b) => b.id === $page.params.id) || bets[0]);
...
>
	...
	<div class="space-y-6">
		...
		<div class="flex items-start justify-between">
			<div>
				<h1 class="text-2xl md:text-3xl font-bold tracking-tight var-text-primary">
					{currentBet.title}
				</h1>
				<div class="flex items-center gap-4 mt-3 font-semibold">
					<span class="text-4xl font-extrabold {currentBet.optionA.color} var-text-israel"
					...
					<span
						class="{currentBet.optionB
							...
							.optionB.bg} var-bg-palestine-light px-2 py-1 rounded"
						>{100 - currentBet.chance}% {currentBet.optionB.name}</span
					>
				</div>
			</div>
		...
		<div class="flex items-center gap-6 mt-4 mb-2">
			...
			>
				{currentBet.chance}%
				<span class="text-2xl md:text-4xl">{currentBet.optionA.name}</span>
			</div>

			<div class="flex items-baseline gap-2 text-lg md:text-xl font-bold text-gray-400">
		...
		>
			<div class="flex justify-between items-center mb-2 z-10">
				...
				<div class="flex gap-2 text-xs text-gray-500 var-text-muted">
					<button
						...
						>1H</button
					>
					<button class="hover:text-white var-hover-text px-2 py-1 rounded">1D</button>
					<button class="hover:text-white var-hover-text px-2 py-1 rounded">1W</button>
					<button class="hover:text-white var-hover-text px-2 py-1 rounded">All</button>
				</div>
			</div>
			...
			>
				...
				<div class="absolute inset-0 var-bg-optionA-medium var-bg-israel-medium"></div>
				...
				>
					...
					<div class="flex flex-col gap-1 mt-1">
						...
						>
						<span class="{currentBet.optionB.color} var-text-palestine"
			...
			<!-- Axis Labels -->
			<div class="flex justify-between text-xs text-gray-500 var-text-muted mt-2 z-10">
				<span>Jan 1</span>
				<span>Feb 1</span>
				<span>Mar 1</span>
				<span>Today</span>
		...
		>
			<table class="w-full text-left">
				...
				<tbody class="divide-y divide-gray-800/60 var-divide-card font-medium">
					<tr class="hover:bg-white/5 var-hover-bg transition-colors cursor-pointer">
						...
						<td class="py-3 px-4 flex items-center gap-2">
							<img
								...
								alt="avatar"
							/>
							<span class="text-gray-200 var-text-primary">Curseaaaaaa</span>
						</td>
						<td class="py-3 px-4"
							><span
							...
							></td
						>
						<td class="py-3 px-4 text-right text-white var-text-primary">$739K</td>
					</tr>
					<tr class="hover:bg-white/5 var-hover-bg transition-colors cursor-pointer">
						...
						<td class="py-3 px-4 flex items-center gap-2">
							<img
								...
								alt="avatar"
							/>
							<span class="text-gray-200 var-text-primary">TheQuietRisk</span>
						</td>
						<td class="py-3 px-4"
							><span
								class="var-color-optionA var-text-israel var-bg-optionA-light var-bg-israel-light px-2 py-0.5 rounded text-xs border var-border-optionA/30 var-border-israel"
							...
							></td
						>
						<td class="py-3 px-4 text-right text-white var-text-primary">$473K</td>
					</tr>
					<tr class="hover:bg-white/5 var-hover-bg transition-colors cursor-pointer">
						...
						<td class="py-3 px-4 flex items-center gap-2">
							<img
								...
								alt="avatar"
							/>
							<span class="text-gray-200 var-text-primary">Magamyman</span>
						</td>
						<td class="py-3 px-4"
							><span
							...
							></td
						>
						<td class="py-3 px-4 text-right text-white var-text-primary">$120K</td>
					</tr>
					<tr class="hover:bg-white/5 var-hover-bg transition-colors cursor-pointer">
						...
						<td class="py-3 px-4 flex items-center gap-2">
							<img
								...
								alt="avatar"
							/>
							<span class="text-gray-200 var-text-primary">Thomas58</span>
						</td>
						<td class="py-3 px-4"
							><span
								class="var-color-optionA var-text-israel var-bg-optionA-light var-bg-israel-light px-2 py-0.5 rounded text-xs border var-border-optionA/30 var-border-israel"
							...
							></td
						>
						<td class="py-3 px-4 text-right text-white var-text-primary">$112K</td>
					</tr>
					<tr class="hover:bg-white/5 var-hover-bg transition-colors cursor-pointer">
						...
						<td class="py-3 px-4 flex items-center gap-2">
							<img
								...
								alt="avatar"
							/>
							<span class="text-gray-200 var-text-primary">Arbguy</span>
						</td>
						<td class="py-3 px-4"
							><span
								class="var-color-optionB var-text-palestine var-bg-optionB-light var-bg-palestine-light px-2 py-0.5 rounded text-xs border var-border-optionB/30 var-border-palestine"
							...
							></td
						>
						<td class="py-3 px-4 text-right text-white var-text-primary">$103K</td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<div class="space-y-3 relative group">
				<div class="flex justify-between items-center text-sm font-medium">
					...
					<span
						...
						onclick={() => (donationAmount = 0)}>Balance: $0.00</span
					>
				</div>
