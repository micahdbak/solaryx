<script>
    ...
    function getChartPaths(sharesData, selectedTimeframe) {
        ...
        const initialY =
            initialSum === 0 ? 100 : 100 - (totalA / initialSum) * 100;
        ...
        sharesData.forEach((share) => {
            ...
            if (t > cutoff) {
                ...
                const x = Math.max(
                    0,
                    Math.min(100, ((t - startTime) / timeRange) * 100),
                );
    ...
    function getAxisLabels(selectedTimeframe) {
        ...
        if (selectedTimeframe === "1H") {
            for (let i = 0; i < count; i++) {
                const d = new Date(
                    now.getTime() - (count - 1 - i) * 15 * 60 * 1000,
                );
                labels.push(
            ...
            for (let i = 0; i < count; i++) {
                const d = new Date(
                    now.getTime() - (count - 1 - i) * 6 * 60 * 60 * 1000,
                );
                labels.push(
                    d.toLocaleTimeString([], {
                        hour: "2-digit",
            ...
            for (let i = 0; i < count; i++) {
                const d = new Date(
                    now.getTime() - (count - 1 - i) * 2 * 24 * 60 * 60 * 1000,
                );
                labels.push(
    ...
    >
        ...
        <div class="space-y-4">
            ...
            <div class="relative p-0 flex flex-col overflow-hidden">
                <div class="mb-2 pt-4">
                    <h1
                        class="text-2xl md:text-3xl font-bold tracking-tight var-text-primary mb-2"
                    >
                        {currentBet.title}
                    </h1>
                    ...
                    <div class="flex justify-between items-center mb-2">
                        <div class="flex items-baseline gap-4">
                            ...
                            >
                                {currentBet.totalSol === 0
                                    ? 0
                                    : 100 - currentBet.chance}% {currentBet
                                    .optionB.name}
                            </span>
                        </div>
                        <div
                            class="flex gap-2 text-xs text-gray-500 var-text-muted"
                        >
                            <button
                    ...
                    <!-- Axis Labels -->
                    <div
                        class="flex justify-between text-xs text-gray-500 var-text-muted mt-2"
                    >
                    ...
                    {#if currentBet.description}
                        <p
                            class="text-gray-400 text-sm leading-relaxed mt-4 break-words"
                        >
                    ...
                    {#if charity}
                        ...
                        >
                            <div class="flex items-center gap-4">
                                ...
                                {:else}
                                    <h4
                                        class="text-lg font-bold text-white w-full break-words"
                                    >
                                        {charity.name}
                                    </h4>
                                {/if}
        ...
        <div class="sticky top-24 self-start space-y-3">
            ...
            >
                ...
                >
                    <h2
                        class="text-xl font-bold text-white transition-colors duration-700"
                    >
                        Make an Impact
                    </h2>
                    <div
                ...
                <div class="space-y-3 relative group">
                    ...
                    <div class="flex gap-2 text-xs font-semibold">
                        <button
                            ...
                            onclick={() =>
                                (donationAmount = parseFloat(
                                    (Number(donationAmount || 0) + 0.1).toFixed(
                                        2,
                                    ),
                                ))}>+0.1</button
                        >
                        <button
                            ...
                            onclick={() =>
                                (donationAmount = parseFloat(
                                    (Number(donationAmount || 0) + 0.5).toFixed(
                                        2,
                                    ),
                                ))}>+0.5</button
                        >
                        <button
                            ...
                            onclick={() =>
                                (donationAmount = parseFloat(
                                    (Number(donationAmount || 0) + 1).toFixed(
                                        2,
                                    ),
                                ))}>+1</button
                        >
                        <button
                            ...
                            onclick={() =>
                                (donationAmount = parseFloat(
                                    (Number(donationAmount || 0) + 5).toFixed(
                                        2,
                                    ),
                                ))}>+5</button
                        >
